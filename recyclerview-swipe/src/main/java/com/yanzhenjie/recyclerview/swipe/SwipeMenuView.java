    ...
    private View.OnClickListener mMenuClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (mItemClickListener != null && mSwipeSwitch != null && mSwipeSwitch.isMenuOpen()) {
                Log.d(TAG, "onClick: "+mAdapterVIewHolder);
                mItemClickListener.onItemClick(mSwipeSwitch, mAdapterVIewHolder == null ? position : mAdapterVIewHolder.getAdapterPosition(), v.getId(), mDirection);
            }
        }
    };
